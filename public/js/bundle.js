...
var Footer = function (_React$Component) {
  ...
  _createClass(Footer, [{
    ...
    key: 'componentWillUnmoount',
    value: function componentWillUnmoount() {
...
var FooterStore = function () {
  ...
  _createClass(FooterStore, [{
    ...
    value: function onGetTopCharactersFail(jqXhr) {
      toastr.error(jqXhr.responseJSON && jqXhr.responseJSON.message || jqXhr.responseJSON.responseText || jqXhr.responseJSON.statusText);
    }
  }]);
